...
public final class SimulatedVehicleStateFactory {
    ...
    public SimulatedVehicleStateFactory(
    ...
    public SimulatedVehicleState create(ProvisionedVehicle vehicle) {
        return SimulatedVehicleState.initial(
                vehicle,
                properties.initialOdometerKm(),
                initialLatitude,
                initialLongitude
        );
    }

    private static void requireCoordinate(double value, double minimum, double maximum, String field) {
