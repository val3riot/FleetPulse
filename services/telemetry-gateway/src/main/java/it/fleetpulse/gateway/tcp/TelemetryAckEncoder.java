...
public class TelemetryAckEncoder {
    ...
    public void write(TelemetryAck acknowledgement, OutputStream output) throws IOException {
        Objects.requireNonNull(acknowledgement, "acknowledgement must not be null");
