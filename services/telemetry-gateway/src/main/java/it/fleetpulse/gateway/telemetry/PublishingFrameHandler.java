...
public final class PublishingFrameHandler implements FrameHandler {
    private static final Logger log =
            LoggerFactory.getLogger(PublishingFrameHandler.class);
    ...
    public TelemetryAck handle(TelemetryMessage message) {
        ...
        try {
            ...
            log.warn(
                    "Kafka publication interrupted: messageId={}, vehicleId={}",
                    event.messageId(),
                    event.vehicleId()
            );
            ...
            metrics.publicationFailed();
            log.warn(
                    "Kafka publication not confirmed: messageId={}, vehicleId={}, failure={}",
                    event.messageId(),
                    event.vehicleId(),
