...
class VehicleStateCacheHitDatabaseUnavailableIntegrationTest {
    @Container
    ...
    @Test
    void cacheHitSurvivesStoppedPostgresAndMissProduces503() throws Exception {
