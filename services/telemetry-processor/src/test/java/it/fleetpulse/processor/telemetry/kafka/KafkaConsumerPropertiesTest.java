...
class KafkaConsumerPropertiesTest {
    ...
    void bindsValidRetryConfiguration() {
        contextRunner
                .withPropertyValues(
                        "fleetpulse.kafka.consumer.group-id=test-group",
                ...
                .run(context -> {
                    ...
                    assertThat(properties.retryMaxAttempts())
                            .isEqualTo(3);
                    assertThat(properties.retryInitialBackoff())
                            .isEqualTo(Duration.ofMillis(500));
                    assertThat(properties.retryMaxBackoff())
                            .isEqualTo(Duration.ofSeconds(5));
                    assertThat(properties.retryMultiplier())
                            .isEqualTo(2.0);
                    assertThat(properties.retryJitterRatio())
                            .isEqualTo(0.2);
                });
    }
