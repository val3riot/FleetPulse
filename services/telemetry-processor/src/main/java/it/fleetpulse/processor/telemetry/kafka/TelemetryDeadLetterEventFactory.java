...
public final class TelemetryDeadLetterEventFactory {
    ...
    public TelemetryDeadLetterEvent create(
        ...
        return new TelemetryDeadLetterEvent(
                ...
                record.partition(),
                record.offset(),
                attemptResolver.resolve(record),
                errorCode(failure),
                errorMessage(rootCause),
                Objects.toString(record.key(), null),
